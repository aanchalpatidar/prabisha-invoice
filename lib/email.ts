...
function formatCurrency(amountInINR, currency) {
...
export async function sendInvoiceEmail(invoice: any, pdfBuffer?: Buffer) {
  try {
    ...
    const secondaryColor = invoice.company?.secondaryColor || '#10b981';
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            ...
            <h1 style="color: ${primaryColor}; margin: 0;">Invoice ${invoice.invoiceNumber}</h1>
          </div>
          
          <p>Dear ${invoice.customer.name},</p>
          <p>Please find your invoice details below for the amount of <strong>${formatCurrency(invoice.total, invoice.currency)}</strong>.</p>
          
          <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid ${primaryColor};">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr>
                ...
                <td style="padding: 8px 0; font-size: 18px; font-weight: bold; color: ${primaryColor};">${formatCurrency(invoice.total, invoice.currency)}</td>
              </tr>
            </table>
          </div>
          ...
          ${
            invoice.company?.bankName
              ? `
            <div style="background: #ecfdf5; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid ${secondaryColor};">
              <h3 style="margin-top: 0; color: ${secondaryColor};">Payment Information</h3>
              <table style="width: 100%; border-collapse: collapse;">
                <tr>
          ...
          <div style="margin: 30px 0;">
            <h3 style="color: ${primaryColor};">Items:</h3>
            <table style="width: 100%; border-collapse: collapse; border: 1px solid #e5e7eb;">
              <thead>
                <tr style="background: ${secondaryColor}22;"> <!-- 22 for light tint -->
              ...
              <tbody>
                ${invoice.lineItems
                  ...
                  <tr>
                    ...
                    <td style="padding: 12px; text-align: right; border-bottom: 1px solid #f3f4f6;">${formatCurrency(item.price, invoice.currency)}</td>
                    <td style="padding: 12px; text-align: right; border-bottom: 1px solid #f3f4f6;">${formatCurrency(item.quantity * item.price, invoice.currency)}</td>
                  </tr>
                `,
                  )
                  .join("")}
    ...
    const mailOptions: any = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <p>Thank you for your interest in our services. Please find your quotation details below for the amount of <strong>${formatCurrency(quotation.total, quotation.currency)}</strong>.</p>
          ...
          <div style="background: #f0fdf4; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #10b981;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr>
                <td style="padding: 8px 0; font-weight: bold;">Amount:</td>
                <td style="padding: 8px 0; font-size: 18px; font-weight: bold; color: #10b981;">${formatCurrency(quotation.total, quotation.currency)}</td>
              </tr>
            </table>
          </div>
              ...
              <tbody>
                ${quotation.lineItems
                  ...
                  <tr>
                    ...
                    <td style="padding: 12px; text-align: center; border-bottom: 1px solid #f3f4f6;">${item.quantity}</td>
                    <td style="padding: 12px; text-align: right; border-bottom: 1px solid #f3f4f6;">${formatCurrency(item.price, quotation.currency)}</td>
                    <td style="padding: 12px; text-align: right; border-bottom: 1px solid #f3f4f6;">${formatCurrency(item.quantity * item.price, quotation.currency)}</td>
                  </tr>
                `,
                  )
                  .join("")}
