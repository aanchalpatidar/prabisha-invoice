        ...
        {company?.bankName && (
          <div className="space-y-2">
            ...
            <div className="text-sm space-y-1">
              <p>
                <span className="font-medium">Bank:</span> {company.bankName}
              </p>
              {company.bankAccount && (
                <p>
                  <span className="font-medium">Account:</span> {company.bankAccount}
                </p>
              )}
              {company.bankIFSC && (
                <p>
                  <span className="font-medium">IFSC/Sort Code:</span> {company.bankIFSC}
                </p>
              )}
            </div>
          </div>
